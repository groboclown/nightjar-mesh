...
ALLOWED_PROXY_MODES = (SERVICE_PROXY_MODE, GATEWAY_PROXY_MODE)
...
class Config:  # pylint: disable=R0902
    ...
    __slots__ = (
        ...
        'envoy_config_dir', 'envoy_config_file',
    ...
    def __init__(self, env: Dict[str, str]) -> None:
        ...
        self.refresh_time = parse_env.env_as_int(
            env, ENV__REFRESH_TIME, DEFAULT_REFRESH_TIME,
        )
        self.failure_sleep = parse_env.env_as_int(
