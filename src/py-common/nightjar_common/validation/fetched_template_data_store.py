...
def validate_fetched_template_data_store_schema_yaml(data: Dict[str, Any]) -> Dict[str, Any]:
    if not isinstance(data, (dict)):
        raise JsonSchemaException("data must be object", value=data, name="data", definition={'$schema': 'https://json-schema.org/draft-07/schema', 'description': 'Entry data fetched from the data store.', 'type': 'object', 'required': ['version', 'commit-version', 'activity', 'gateway-templates', 'service-templates'], 'properties': {'version': {'description': 'Version of this document\'s schema.  The value must be the string value "v1".', 'const': 'v1'}, 'commit-version': {'description': 'Opaque ID for the commit version.  Allows for atomic commits on multiple data storage types.', 'type': 'string'}, 'activity': {'description': 'The activity associated with the entries.  Must be "template".', 'const': 'template'}, 'gateway-templates': {'description': 'Template values fetched.', 'type': 'array', 'items': {'type': 'object', 'required': ['namespace', 'purpose', 'template'], 'properties': {'namespace': {'description': 'Namespace of this template, or `null` if this is the default gateway template.', 'type': ['string', 'null']}, 'purpose': {'description': 'The purpose of this template, which is usually the destination file name, such as "cds.yaml" or "lds.yaml".  Multiple of these can be provided per namespace.\n', 'type': 'string'}, 'template': {'description': 'The template text.', 'type': 'string'}}}}, 'service-templates': {'description': 'Template values fetched.', 'type': 'array', 'items': {'type': 'object', 'required': ['namespace', 'service', 'color', 'purpose', 'template'], 'properties': {'namespace': {'description': 'Namespace of this template, or `null` if this is the default gateway template.', 'type': ['string', 'null']}, 'service': {'description': 'Service of this template, or `null` if this is the default service template.', 'type': ['string', 'null']}, 'color': {'description': 'Color of this template, or `null` if this is the default service color template.  Note that if `service` is "null", then this must also be "null".\n', 'type': ['string', 'null']}, 'purpose': {'description': 'The purpose of this template, which is usually the destination file name, such as "cds.yaml" or "lds.yaml".  Multiple of these can be provided per namespace.\n', 'type': 'string'}, 'template': {'description': 'The template text.', 'type': 'string'}}}}}, '$id': 'file:/tmp/tmpi29sscui/fetched-template-data-store-schema.yaml'}, rule='type')
    data_is_dict = isinstance(data, dict)
    if data_is_dict:
        data_len = len(data)
        if not all(prop in data for prop in ['version', 'commit-version', 'activity', 'gateway-templates', 'service-templates']):
            raise JsonSchemaException("data must contain ['version', 'commit-version', 'activity', 'gateway-templates', 'service-templates'] properties", value=data, name="data", definition={'$schema': 'https://json-schema.org/draft-07/schema', 'description': 'Entry data fetched from the data store.', 'type': 'object', 'required': ['version', 'commit-version', 'activity', 'gateway-templates', 'service-templates'], 'properties': {'version': {'description': 'Version of this document\'s schema.  The value must be the string value "v1".', 'const': 'v1'}, 'commit-version': {'description': 'Opaque ID for the commit version.  Allows for atomic commits on multiple data storage types.', 'type': 'string'}, 'activity': {'description': 'The activity associated with the entries.  Must be "template".', 'const': 'template'}, 'gateway-templates': {'description': 'Template values fetched.', 'type': 'array', 'items': {'type': 'object', 'required': ['namespace', 'purpose', 'template'], 'properties': {'namespace': {'description': 'Namespace of this template, or `null` if this is the default gateway template.', 'type': ['string', 'null']}, 'purpose': {'description': 'The purpose of this template, which is usually the destination file name, such as "cds.yaml" or "lds.yaml".  Multiple of these can be provided per namespace.\n', 'type': 'string'}, 'template': {'description': 'The template text.', 'type': 'string'}}}}, 'service-templates': {'description': 'Template values fetched.', 'type': 'array', 'items': {'type': 'object', 'required': ['namespace', 'service', 'color', 'purpose', 'template'], 'properties': {'namespace': {'description': 'Namespace of this template, or `null` if this is the default gateway template.', 'type': ['string', 'null']}, 'service': {'description': 'Service of this template, or `null` if this is the default service template.', 'type': ['string', 'null']}, 'color': {'description': 'Color of this template, or `null` if this is the default service color template.  Note that if `service` is "null", then this must also be "null".\n', 'type': ['string', 'null']}, 'purpose': {'description': 'The purpose of this template, which is usually the destination file name, such as "cds.yaml" or "lds.yaml".  Multiple of these can be provided per namespace.\n', 'type': 'string'}, 'template': {'description': 'The template text.', 'type': 'string'}}}}}, '$id': 'file:/tmp/tmpi29sscui/fetched-template-data-store-schema.yaml'}, rule='required')
        ...
        if "service-templates" in data_keys:
            ...
            if not isinstance(data__servicetemplates, (list, tuple)):
                raise JsonSchemaException("data.service-templates must be array", value=data__servicetemplates, name="data.service-templates", definition={'description': 'Template values fetched.', 'type': 'array', 'items': {'type': 'object', 'required': ['namespace', 'service', 'color', 'purpose', 'template'], 'properties': {'namespace': {'description': 'Namespace of this template, or `null` if this is the default gateway template.', 'type': ['string', 'null']}, 'service': {'description': 'Service of this template, or `null` if this is the default service template.', 'type': ['string', 'null']}, 'color': {'description': 'Color of this template, or `null` if this is the default service color template.  Note that if `service` is "null", then this must also be "null".\n', 'type': ['string', 'null']}, 'purpose': {'description': 'The purpose of this template, which is usually the destination file name, such as "cds.yaml" or "lds.yaml".  Multiple of these can be provided per namespace.\n', 'type': 'string'}, 'template': {'description': 'The template text.', 'type': 'string'}}}}, rule='type')
