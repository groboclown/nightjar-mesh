...
def validate_commit_configuration_data_store_schema_yaml(data: Dict[str, Any]) -> Dict[str, Any]:
    if not isinstance(data, (dict)):
        raise JsonSchemaException("data must be object", value=data, name="data", definition={'$schema': 'https://json-schema.org/draft-07/schema', 'description': 'Entry data committed into the data store.', 'type': 'object', 'required': ['version', 'activity', 'gateway-configurations', 'service-configurations'], 'properties': {'version': {'description': 'Version of this document\'s schema.  The value must be the string value "v1".', 'const': 'v1'}, 'activity': {'description': 'The activity associated with the entries.  Must be "configuration".', 'const': 'configuration'}, 'gateway-configurations': {'description': 'Gateway configuration values committed.', 'type': 'array', 'items': {'type': 'object', 'required': ['namespace', 'protection', 'purpose', 'configuration'], 'properties': {'namespace': {'description': 'Namespace of this template, or `null` if this is the default gateway template.', 'type': ['string', 'null']}, 'purpose': {'description': 'The purpose of this template, which is usually the destination file name, such as "cds.yaml" or "lds.yaml".  Multiple of these can be provided per namespace.\n', 'type': 'string'}, 'configuration': {'description': 'The configured text.', 'type': 'string'}}}}, 'service-configurations': {'description': 'Service configuration values committed.', 'type': 'array', 'items': {'type': 'object', 'required': ['namespace', 'service', 'color', 'purpose', 'configuration'], 'properties': {'namespace': {'description': 'Namespace of this template, or `null` if this is the default gateway template.', 'type': ['string', 'null']}, 'purpose': {'description': 'The purpose of this template, which is usually the destination file name, such as "cds.yaml" or "lds.yaml".  Multiple of these can be provided per namespace.\n', 'type': 'string'}, 'configuration': {'description': 'The configured text.', 'type': 'string'}}}}}, '$id': 'file:/tmp/tmpi29sscui/commit-configuration-data-store-schema.yaml'}, rule='type')
    data_is_dict = isinstance(data, dict)
    if data_is_dict:
        data_len = len(data)
        if not all(prop in data for prop in ['version', 'activity', 'gateway-configurations', 'service-configurations']):
            raise JsonSchemaException("data must contain ['version', 'activity', 'gateway-configurations', 'service-configurations'] properties", value=data, name="data", definition={'$schema': 'https://json-schema.org/draft-07/schema', 'description': 'Entry data committed into the data store.', 'type': 'object', 'required': ['version', 'activity', 'gateway-configurations', 'service-configurations'], 'properties': {'version': {'description': 'Version of this document\'s schema.  The value must be the string value "v1".', 'const': 'v1'}, 'activity': {'description': 'The activity associated with the entries.  Must be "configuration".', 'const': 'configuration'}, 'gateway-configurations': {'description': 'Gateway configuration values committed.', 'type': 'array', 'items': {'type': 'object', 'required': ['namespace', 'protection', 'purpose', 'configuration'], 'properties': {'namespace': {'description': 'Namespace of this template, or `null` if this is the default gateway template.', 'type': ['string', 'null']}, 'purpose': {'description': 'The purpose of this template, which is usually the destination file name, such as "cds.yaml" or "lds.yaml".  Multiple of these can be provided per namespace.\n', 'type': 'string'}, 'configuration': {'description': 'The configured text.', 'type': 'string'}}}}, 'service-configurations': {'description': 'Service configuration values committed.', 'type': 'array', 'items': {'type': 'object', 'required': ['namespace', 'service', 'color', 'purpose', 'configuration'], 'properties': {'namespace': {'description': 'Namespace of this template, or `null` if this is the default gateway template.', 'type': ['string', 'null']}, 'purpose': {'description': 'The purpose of this template, which is usually the destination file name, such as "cds.yaml" or "lds.yaml".  Multiple of these can be provided per namespace.\n', 'type': 'string'}, 'configuration': {'description': 'The configured text.', 'type': 'string'}}}}}, '$id': 'file:/tmp/tmpi29sscui/commit-configuration-data-store-schema.yaml'}, rule='required')
