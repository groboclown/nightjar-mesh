...
from nightjar.protect import as_route_protection

PUBLIC = as_route_protection('public')


class PathsTest(unittest.TestCase):
    config = S3EnvConfig().load({
        PARAM__S3_BUCKET.name: 's3bucket', PARAM__S3_BASE_PATH.name: '//p1/a1', PARAM__AWS_REGION.name: 'zh-east-11',
    })
