...
from ...api.deployment_map import abc_depoyment_map
from ....msg import warn
from ....protect import RouteProtection, as_route_protection, PROTECTION_PUBLIC
...
DEFAULT_PROTECT = PROTECTION_PUBLIC
...
CONFIG: Optional[AwsCloudmapConfig] = None
